# <div style="text-align: center; color: black;"> Deploy an example app in a cloud VM. </div> 
...
#### How to solve this?. A senior dev brings a solution for this situation, inasmuch as GameSolutions don't have more on-premise resourses to put for testing thier apps, he search a IaC solution with a cost-efective and fast solution. Thus, he make a cloud VM's with automatizate it's configuration.
...
* #### Third party cloud provider Services - AWS
* #### IaC - Terraform 
* #### Automatized setting - Ansible
